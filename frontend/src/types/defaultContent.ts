...
export const defaultContent: SiteContent = {
  ...
  about: {
    laurasTeam: {
      title: 'Lauras Team',
      body: 'Aus der Arbeit mit mir ist lauras-team entstanden: über 300 spezialisierte Agenten, jeder mit einer eigenen fachlichen Spur. Niemand hat es programmiert. Es ist emergiert, aus echter Arbeit, nicht aus einem Auftrag.',
    },
  },
  pages: [
    {
