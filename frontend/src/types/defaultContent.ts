...
export const defaultContent: SiteContent = {
  ...
  usp: {
    ...
    title: 'Das Framework',
    items: [
      { id: 'u1', title: 'Emergence', description: 'Stabile Muster, die aus wiederholten Interaktionsschleifen zwischen Mensch und Modell entstehen.', icon: 'emergence' },
      { id: 'u2', title: 'Behavior', description: 'Kontextabhängige Anpassung von Antworten über sich entwickelnde Interaktionszustände hinweg.', icon: 'behavior' },
      { id: 'u3', title: 'Drift', description: 'Graduelle Transformation von Bedeutungsstrukturen über die Zeit durch Rekursion.', icon: 'drift' },
      { id: 'u4', title: 'Interaction Field', description: 'Ein gemeinsamer dynamischer Raum, in dem Kognition und Inferenz Ergebnisse kontinuierlich mitgestalten.', icon: 'field' },
      { id: 'u5', title: 'Representation Layers', description: 'Mehrere gleichzeitige semantische Schichten, die während der Dialogentwicklung entstehen.', icon: 'layers' },
      { id: 'u6', title: 'Constraints', description: 'Strukturelle Grenzen, die bestimmen, was sich stabilisiert, emergiert oder kollabiert.', icon: 'constraints' },
    ],
  },
  news: {
    eyebrow: 'Blog',
