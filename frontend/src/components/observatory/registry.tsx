...
export const OBSERVATORY_MODULES: ObservatoryModuleDef[] = [
  ...
  // Deep Self-Analysis (40/40/20): Bucket 1 (Laura's Mind) + Bucket 2
  // (Jarvis the Machine) are folded into Behavioral Landscape / Agent-
  // Aktivität; Bucket 3+META (Dyad + Meta) is folded into Emergence Monitor.
  // No standalone apps — the metrics REPLACE the useless old aggregates there
  // instead of spawning a new app zoo (2026-07-25).
]
