  ...
  return (
    <div className="obs-panel">
      ...
      <p style={{ fontSize: 12, color: '#888', lineHeight: 1.6 }}>
        Konfidenz ist der mittlere Token-Wahrscheinlichkeitswert aus den letzten Antworten (siehe /api/inspect) —
        ein Signal über Modellsicherheit, keine Aussage über inhaltliche Richtigkeit.
      </p>
    </div>
  )
}
