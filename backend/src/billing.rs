...
pub async fn seed_webhub_products(db: &SqlitePool) {
    ...
    let seeds = [
        ...
        Seed {
            name: "Rollenreview",
            en_desc: "Who actually owns which decision, and where that's unclear or silently double-owned.",
            de_desc: "Wer trägt welche Entscheidung wirklich - und wo ist das unklar oder doppelt vergeben.",
            price_cents: 300_000,
            mode: "payment",
            recurring_interval: None,
        ...
        Seed {
            name: "Prozessreview",
            en_desc: "Where a process holds up under real load, and where it stalls at a handoff or an edge case.",
            de_desc: "Wo ein Prozess unter echter Last hält - und wo er an einer Übergabe oder einem Randfall stockt.",
            price_cents: 450_000,
            mode: "payment",
            recurring_interval: None,
        ...
        Seed {
            ...
            en_desc: "Where two systems or teams hand off to each other, and what actually gets lost or misread in that handoff.",
            de_desc: "Wo zwei Systeme oder Teams übergeben - und was dabei tatsächlich verloren geht oder falsch verstanden wird.",
            price_cents: 450_000,
            mode: "payment",
            recurring_interval: None,
        ...
        Seed {
            name: "Betriebsreview",
            en_desc: "Whether day-to-day operations can actually be watched and kept alive, not just launched.",
            de_desc: "Ob der laufende Betrieb wirklich beobachtbar und am Leben zu halten ist - nicht nur startklar.",
            price_cents: 500_000,
            mode: "payment",
            recurring_interval: None,
        ...
        Seed {
            name: "Verhaltensreview",
            en_desc: "Where behavior actually shifts under sustained interaction - tool usage, tone, confidence - read as a trend, not dressed up as prediction.",
            de_desc: "Wo sich Verhalten unter anhaltender Interaktion tatsächlich verschiebt - Werkzeugnutzung, Tonfall, Sicherheit - als Trend gelesen, nicht als Vorhersage verkauft.",
            price_cents: 500_000,
            mode: "payment",
            recurring_interval: None,
            payment_link_url: "https://buy.stripe.com/8x2cN77SMgajgCFgY07N60E",
        },
        Seed {
            name: "Organisationsreview",
            en_desc: "The organisation as a whole: reporting lines, ownership gaps, and handovers that quietly break between teams.",
            de_desc: "Die Organisation als Ganzes: Berichtslinien, Zuständigkeitslücken und Übergaben, die zwischen Teams still brechen.",
            price_cents: 550_000,
            mode: "payment",
            recurring_interval: None,
        ...
        Seed {
            name: "Produktreview",
            en_desc: "Where the product's actual usage logic creates friction a user has to work around.",
            de_desc: "Wo die tatsächliche Nutzungslogik des Produkts Reibung erzeugt, die Nutzer:innen umgehen müssen.",
            price_cents: 550_000,
            mode: "payment",
            recurring_interval: None,
